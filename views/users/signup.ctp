...
<fieldset>
  ...
  <div class="input text required">
    ...
    <?php if($form->isFieldError('User.address1')) 
            e($form->error ('User.address1', 
                            null, 
                            array('class' => 'message'))); 
    ?>
  ...
  <div class="input text required">
    ...
    <?php if($form->isFieldError('User.address2')) 
            e($form->error ('User.address2', 
                            null, 
                            array('class' => 'message'))); 
    ?>
  ...
  <div class="input text required">
    ...
    <?php if($form->isFieldError('User.address3')) 
            e($form->error ('User.address3', 
                            null, 
                            array('class' => 'message'))); 
    ?>
