...
<?php 
echo $html->css('jquery-ui/redmond/jquery-ui-1.8.2.custom', null, 
                array('inline' => false)); 
?>
<!-- Begin Navigation  -->
    ...
    <div class="module" id="changelist">
      <div id="toolbar">
        ...
        <div><!-- DIV needed for valid HTML -->
          ...
          <?php 
            e($html->link('View All', '/supplier/products/index', 
                array('class' => 'a-button')))
          ?>
          &nbsp;&nbsp;
          <?php 
            e($html->link('Show Available Items',
                '/supplier/products/index?display=yes', 
                array('class' => 'a-button')));
          ?>
