$(document).ready(function(){
  jQuery('#products').jqGrid({
    ...
    colNames: ['Id', 'Short Description', 'Selling Price', 'Buying Price', 
               'Quantity', 'Stock', 'Display', 'Actions'], 
    colModel:[
      {id: 'id', index: 'id', width:30},
      {name:'short_description',index:'short_description', width:330, 
       editable: true},
      ...
      {name:'stock', index:'stock', width:60, align:"right", editable: true},
      {name:'display', index:'display', width:60, align:"right",editable: true,
